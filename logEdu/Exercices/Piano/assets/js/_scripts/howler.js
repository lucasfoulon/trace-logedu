...
(function() {
  ...
  var ctx = null,
    ...
    console.log("Init son...");

  if (typeof AudioContext !== 'undefined') {
        ctx = new AudioContext();
        console.log("On utilise AudioContext");
  } else if (typeof webkitAudioContext !== 'undefined') {
        ctx = new webkitAudioContext();
        console.log("On utilise webkitAudioContext");
  } else if (typeof Audio !== 'undefined') {
        usingWebAudio = false;
        try {
            new Audio();
            console.log("On utilise Audio");
        } catch(e) {
            noAudio = true;
        }
  } else {
